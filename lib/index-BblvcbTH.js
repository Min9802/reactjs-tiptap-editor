  ...
  */
  findIndex(e) {
    if (e == 0)
      return xe(0, e);
    if (e == this.size)
      return xe(this.content.length, e);
    if (e > this.size || e < 0)
      throw new RangeError(`Position ${e} outside of fragment (${this})`);
    for (let t = 0, n = 0; ; t++) {
      let i = this.child(t), s = n + i.nodeSize;
      if (s >= e)
        return s == e ? xe(t + 1, s) : xe(t, n);
      n = s;
    }
  }
  /**
...
let F = class Xe {
  ...
  */
  eq(e) {
    return this == e || this.type == e.type && Ke(this.attrs, e.attrs);
  }
  /**
...
class k {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new k(w.fromJSON(e, t.content), n, i);
  }
  /**
...
class rt {
  ...
  */
  static compile(e, t) {
    ...
    return e.forEach((s, o) => n[s] = new rt(s, i++, t, o)), n;
  }
  /**
...
class Qe {
  ...
  */
  parseSlice(e, t = {}) {
    let n = new kt(this, t, !0);
    return n.addAll(e, F.none, t.from, t.to), k.maxOpen(n.finish());
  }
  /**
  @internal
  */
  ...
  */
  static schemaRules(e) {
    ...
    for (let i in e.marks) {
      ...
      s && s.forEach((o) => {
        n(o = xt(o)), o.mark || o.ignore || o.clearMark || (o.mark = i);
      });
    }
    for (let i in e.nodes) {
      let s = e.nodes[i].spec.parseDOM;
      s && s.forEach((o) => {
        n(o = xt(o)), o.node || o.ignore || o.mark || (o.node = i);
      });
    }
    return t;
  }
...
class ve {
  constructor(e, t, n, i, s, o) {
    this.type = e, this.attrs = t, this.marks = n, this.solid = i, this.options = o, this.content = [], this.activeMarks = F.none, this.match = s || (o & he ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type)
...
class kt {
  constructor(e, t, n) {
    ...
    let i = t.topNode, s, o = wt(null, t.preserveWhitespace, 0) | (n ? he : 0);
    i ? s = new ve(i.type, i.attrs, F.none, !0, t.topMatch || i.type.contentMatch, o) : n ? s = new ve(null, null, F.none, !0, null, o) : s = new ve(e.schema.topNodeType, null, F.none, !0, null, o), this.nodes = [s], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
...
`), t);
  ...
  insertNode(e, t, n) {
    ...
    if (i) {
      ...
      for (let l of i.concat(e.marks))
        (s.type ? s.type.allowsMarkType(l.type) : vt(l.type, e.type)) && (o = l.addToSet(o));
  ...
  enterInner(e, t, n, i = !1, s) {
    ...
    let l = wt(e, s, o.options);
    o.options & he && o.content.length == 0 && (l |= he);
    let a = F.none;
    return n = n.filter((c) => (o.type ? o.type.allowsMarkType(c.type) : vt(c.type, e)) ? (a = c.addToSet(a), !1) : !0), this.nodes.push(new ve(e, t, a, i, null, l)), this.open++, n;
  }
...
class D {
  ...
  */
  touches(e, t) {
    let n = 0, i = Mt(t), s = this.inverted ? 2 : 1, o = this.inverted ? 1 : 2;
    for (let l = 0; l < this.ranges.length; l += 3) {
...
function it(r, e, t) {
  ...
  for (let i = 0; i < r.childCount; i++) {
    let s = r.child(i);
    s.content.size && (s = s.copy(it(s.content, e, s))), s.isInline && (s = e(s, t, i)), n.push(s);
  }
...
class X extends z {
  ...
  */
  ...
  map(e) {
    ...
    return t.deleted && n.deleted || t.pos >= n.pos ? null : new X(t.pos, n.pos, this.mark);
  }
  merge(e) {
      ...
      if (n.length == t.marks.length) {
        for (let i = 0; i < t.marks.length; i++)
          if (!t.marks[i].isInSet(n))
            return new Y(this.pos, t.marks[i]);
...
class A extends z {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new A(t.from, t.to, t.gapFrom, t.gapTo, k.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
}
z.jsonID("replaceAround", A);
function et(r, e, t) {
...
function er(r, e, t, n) {
  ...
  r.doc.nodesBetween(e, t, (a, c, f) => {
    ...
    if (!n.isInSet(u) && f.type.allowsMarkType(n.type)) {
      let d = Math.max(c, e), h = Math.min(c + a.nodeSize, t), p = n.addToSet(u);
      for (let m = 0; m < u.length; m++)
        u[m].isInSet(p) || (o && o.to == d && o.mark.eq(u[m]) ? o.to = h : i.push(o = new W(d, h, u[m])));
      l && l.to == d ? l.to = h : s.push(l = new X(d, h, n));
    }
  ...
  for (let a = 0; a < s.childCount; a++) {
    ...
    if (!u)
      ...
      for (let d = 0; d < c.marks.length; d++)
        t.allowsMarkType(c.marks[d].type) || r.step(new W(l, f, c.marks[d]));
...
function cr(r, e, t, n, i) {
  ...
  r.step(new A(e, e + s.nodeSize, e + 1, e + s.nodeSize - 1, new k(w.from(o), 0, 0), 1, !0));
}
function K(r, e, t = 1, n) {
  ...
  for (let c = i.depth - 1, f = t - 2; c > s; c--, f--) {
    ...
    if (u.type.spec.isolating)
      return !1;
    let h = u.content.cutByIndex(d, u.childCount), p = n && n[f + 1];
...
class pr {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (t == 1 && (o ? c.matchType(o.type) || (u = c.fillBefore(w.from(o), !1)) : s && a.compatibleContent(s.type)))
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new k(ue(e, t - 1, 1), t - 1, s ? t - 1 : n);
    } else
      this.unplaced = new k(ue(e, t, 1), t, n);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: i, wrap: s }) {
    ...
    this.unplaced = p ? e == 0 ? k.empty : new k(ue(o.content, e - 1, 1), e - 1, h < 0 ? o.openEnd : e - 1) : new k(ue(o.content, e, c), o.openStart, o.openEnd);
  }
  mustMoveInline() {
    if (!this.$to.parent.isTextblock)
      return -1;
    let e = this.frontier[this.depth], t;
    if (!e.type.isTextblock || !je(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: n, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = je(e, t, i, n, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], f = je(e, l, c, a, !0);
          if (!f || f.childCount)
            continue e;
        }
  ...
  openFrontierNode(e, t = null, n) {
    ...
    i.match = i.match.matchType(e), this.placed = de(this.placed, this.depth, w.from(e.create(t, n))), this.frontier.push({ type: e, match: e.contentMatch });
  }
  closeFrontierNode() {
...
function ue(r, e, t) {
  return e == 0 ? r.cutByIndex(t, r.childCount) : r.replaceChild(0, r.firstChild.copy(ue(r.firstChild.content, e - 1, t)));
}
function de(r, e, t) {
...
function yr(r, e, t, n) {
  ...
  for (let d = n.openStart; d >= 0; d--) {
    let h = (d + f + 1) % (n.openStart + 1), p = c[h];
    if (p)
...
class se extends z {
  ...
  */
  ...
  invert(e) {
    return new se(this.pos, this.attr, e.nodeAt(this.pos).attrs[this.attr]);
  }
  map(e) {
    let t = e.mapResult(this.pos, 1);
    return t.deletedAfter ? null : new se(t.pos, this.attr, this.value);
  }
  toJSON() {
  ...
  static fromJSON(e, t) {
    ...
    return new se(t.pos, t.attr, t.value);
  }
}
z.jsonID("attr", se);
class me extends z {
  ...
  */
  ...
  invert(e) {
    return new me(this.attr, e.attrs[this.attr]);
  }
  map(e) {
    return this;
  }
...
class xr {
  ...
  */
  setNodeAttribute(e, t, n) {
    return this.step(new se(e, t, n)), this;
  }
  /**
  ...
  */
  removeNodeMark(e, t) {
    ...
    if (t instanceof F)
      t.isInSet(n.marks) && this.step(new te(e, t));
    else {
      let i = n.marks, s, o = [];
      for (; s = t.isInSet(i); )
        o.push(new te(e, s)), i = s.removeFromSet(i);
...
class E {
  ...
  */
  replace(e, t = k.empty) {
    ...
    for (let l = 0; l < o.length; l++) {
      ...
      e.replaceRange(f.map(a.pos), f.map(c.pos), l ? k.empty : t), l == 0 && At(e, s, (n ? n.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  static findFrom(e, t, n = !1) {
    let i = e.parent.inlineContent ? new P(e) : ne(e.node(0), e.parent, e.pos, e.index(), t, n);
    if (i)
      return i;
  ...
  */
  static atEnd(e) {
    return ne(e, e, e.content.size, e.childCount, -1) || new j(e);
  }
  /**
...
let Ct = !1;
function Tt(r) {
  !Ct && !r.parent.inlineContent && (Ct = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + r.parent.type.name + ")"));
}
class P extends E {
  /**
  ...
  */
  ...
  map(e, t) {
    ...
    return new P(i.parent.inlineContent ? i : n, n);
  }
  replace(e, t = k.empty) {
  ...
  */
  static between(e, t, n) {
    ...
    return e.parent.inlineContent || (i == 0 ? e = t : (e = (E.findFrom(e, -n, !0) || E.findFrom(e, n, !0)).$anchor, e.pos < t.pos != i < 0 && (e = t))), new P(e, t);
  }
}
E.jsonID("text", P);
class ze {
  ...
  if (n.parent.content.size == 0 && (ae(s, "end") || M.isSelectable(s)))
    for (let o = n.depth; ; o--) {
      ...
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = r.tr.step(l);
          a.setSelection(ae(s, "end") ? E.findFrom(a.doc.resolve(a.mapping.map(i.pos, -1)), -1) : M.create(a.doc, i.pos - s.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
function ln(r, e, t) {
  ...
  if (t) {
    let f = r.tr.step(c);
    f.setSelection(P.create(f.doc, s)), t(f.scrollIntoView());
  }
  return !0;
}
function ae(r, e, t = !1) {
...
const fn = (r, e, t) => {
  ...
  if (n.parent.content.size == 0 && (ae(s, "start") || M.isSelectable(s))) {
    ...
    if (o && o.slice.size < o.to - o.from) {
      if (e) {
        let l = r.tr.step(o);
        l.setSelection(ae(s, "start") ? E.findFrom(l.doc.resolve(l.mapping.map(i.pos)), 1) : M.create(l.doc, l.mapping.map(i.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
const Ar = (r, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(n))
    return !1;
  let i = t.node(-1), s = t.indexAfter(-1), o = ft(i.contentMatchAt(s));
  ...
  if (t instanceof j || n.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let s = ft(i.parent.contentMatchAt(i.indexAfter()));
  if (!s || !s.isTextblock)
    return !1;
  if (e) {
...
function Ir(r) {
  return (e, t) => {
    ...
    for (let h = n.depth; ; h--)
      if (n.node(h).isBlock) {
        a = n.end(h) == n.pos + (n.depth - h), c = n.start(h) == n.pos - (n.depth - h), l = ft(n.node(h - 1).contentMatchAt(n.indexAfter(h - 1))), s.unshift(a && l ? { type: l } : null), o = h;
        break;
      } else {
        if (h == 1)
          return !1;
    ...
    let f = e.tr;
    (e.selection instanceof P || e.selection instanceof j) && f.deleteSelection();
    let u = f.mapping.map(n.pos), d = K(f.doc, u, s.length, s);
    if (d || (s[0] = l ? { type: l } : null, d = K(f.doc, u, s.length, s)), !d)
      return !1;
...
function mn(r, e, t, n) {
  ...
  let f = s.type.spec.isolating || n > 0 && a ? null : E.findFrom(e, 1), u = f && f.$from.blockRange(f.$to), d = u && ce(u);
  if (d != null && d >= e.depth)
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (t) {
        ...
        for (let v = p.length - 1; v >= 0; v--)
          y = w.from(p[v].copy(y));
        let x = r.tr.step(new A(e.pos - p.length, e.pos + s.nodeSize, e.pos + g, e.pos + s.nodeSize - g, new k(y, p.length, 0), 0, !0));
        t(x.scrollIntoView());
      }
      return !0;
    }
...
function Fr(r, e, t, n, i) {
  ...
  r.step(new A(e.start - (n ? 2 : 0), e.end, e.start, e.end, new k(s, 0, 0), t.length, !0));
  let o = 0;
...
function Jr(r, e, t) {
  ...
  if (!c.canReplace(f + (l ? 0 : 1), f + 1, o.content.append(a ? w.empty : w.from(i))))
    return !1;
...
function jr(r) {
  return function(e, t) {
    ...
    if (a.type != r)
      return !1;
    if (t) {
      let c = a.lastChild && a.lastChild.type == l.type, f = w.from(c ? r.create() : null), u = new k(w.from(r.create(null, w.from(l.type.create(null, f)))), c ? 3 : 1, 0), d = s.start, h = s.end;
...
function ht(r, e, t) {
  ...
  for (; l < r.parent.childCount && zt([...r.parent.child(l).marks], e, t); )
...
var oi = (r, e) => ({ tr: t, state: n, dispatch: i }) => {
  ...
  if (i) {
    ...
    if (u && u.from <= c && u.to >= f) {
      const d = J.create(o, u.from, u.to);
      t.setSelection(d);
    }
  }
  return !0;
  ...
  if (n)
    try {
      if (Array.isArray(r) && r.length > 0)
        return ie.fromArray(r.map((l) => e.nodeFromJSON(l)));
...
function we(r, e, t = {}) {
  const { from: n, to: i, empty: s } = r.selection, o = e ? N(e, r.schema) : null, l = [];
  r.doc.nodesBetween(n, i, (u, d) => {
    if (u.isText)
      return;
    const h = Math.max(n, d), p = Math.min(i, d + u.nodeSize);
    l.push({
      node: u,
      from: h,
      to: p
...
var Ri = (r, e) => ({ tr: t, state: n, dispatch: i }) => {
  ...
  if (!l)
    return !1;
  l === "node" && (s = N(r, n.schema)), l === "mark" && (o = ee(r, n.schema));
  let a = !1;
...
function En(r, e, t) {
  ...
  return r === e ? t.resolve(r).marks().forEach((i) => {
    ...
    !i || (i == null ? void 0 : i.nodeSize) === void 0 || n.push(
      ...i.marks.map((o) => ({
        from: s,
        to: s + i.nodeSize,
        mark: o
...
var ls = ({ keepMarks: r = !0 } = {}) => ({ tr: e, state: t, dispatch: n, editor: i }) => {
  ...
  ] : void 0, p = K(e.doc, e.mapping.map(l.pos), 1, h);
  if (!h && !p && K(e.doc, e.mapping.map(l.pos), 1, d ? [{ type: d }] : void 0) && (p = !0, h = d ? [
    {
      type: d,
      attrs: f
    }
  ] : void 0), n) {
    if (p && (s instanceof J && e.deleteSelection(), e.split(e.mapping.map(l.pos), 1, h), d && !u && !l.parentOffset && l.parent.type !== d)) {
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      t.doc.nodesBetween(I, t.doc.content.size, (O, L) => {
        if (R > -1)
          return !1;
        O.isTextblock && O.content.size === 0 && (R = L + 1);
  ...
  if (i) {
    ...
    if (t.split(a.pos, 2, g).scrollIntoView(), !S || !i)
      return !0;
    const b = S.filter((I) => v.includes(I.type.name));
    t.ensureMarks(b);
  }
  return !0;
}, qe = (r, e) => {
...
var fs = (r, e, t, n = {}) => ({ editor: i, tr: s, state: o, dispatch: l, chain: a, commands: c, can: f }) => {
  ...
  if ((Be || fe) && H) {
    ...
    if (Ve(H.node.type.name, u) && h.validContent(H.node.content))
      return a().command(() => (s.setNodeMarkup(H.pos, h), !0)).command(() => qe(s, h)).command(() => Ue(s, h)).run();
  }
  return !t || !S || !l ? a().command(() => f().wrapInList(h, n) ? !0 : c.clearNodes()).wrapInList(h, n).command(() => qe(s, h)).command(() => Ue(s, h)).run() : a().command(() => {
  ...
  if (f && o) {
    let { from: d, to: h } = l;
    const p = (s = c.marks().find((g) => g.type === a)) == null ? void 0 : s.attrs, m = ht(c, a, p);
  ...
  return t.selection.ranges.forEach((c) => {
    const f = c.$from.pos, u = c.$to.pos;
    let d, h, p, m;
    t.selection.empty ? n.doc.nodesBetween(f, u, (g, y) => {
      s && s === g.type && (a = !0, p = Math.max(y, f), m = Math.min(y + g.nodeSize, u), d = y, h = g);
    }) : n.doc.nodesBetween(f, u, (g, y) => {
...
var q = class Nn extends mt {
  ...
  addKeyboardShortcuts() {
    const r = () => this.editor.commands.first(({ commands: o }) => [
      ...
      () => o.command(({ tr: l }) => {
        const { selection: a, doc: c } = l, { empty: f, $anchor: u } = a, { pos: d, parent: h } = u, p = u.parent.isTextblock && d > 0 ? l.doc.resolve(d - 1) : u, m = p.parent.type.spec.isolating, g = u.pos - u.parentOffset, y = m && p.parent.childCount === 1 ? g === u.pos : re.atStart(c).from === d;
    ...
    return [
      new Q({
        ...
        props: {
          attributes: () => {
            var r;
            return !this.editor.isEditable && this.options.value === void 0 ? {} : { tabindex: (r = this.options.value) != null ? r : "0" };
          }
        }
      })
    ];
  ...
  return new Pe({
    ...
    handler: ({ state: e, range: t, match: n, chain: i }) => {
      ...
      if (o.wrap(a, c), r.keepMarks && r.editor) {
        const { selection: u, storedMarks: d } = e, { splittableMarks: h } = r.editor.extensionManager, p = d || u.$to.parentOffset && u.$from.marks();
        if (p) {
...
var Os = (r) => "touches" in r, po = class {
  ...
  constructor(r) {
    ...
    }), (o = r.options) != null && o.createCustomHandle && (this.createCustomHandle = r.options.createCustomHandle), this.wrapper = this.createWrapper(), this.container = this.createContainer(), this.applyInitialSize(), this.attachHandles(), this.editor.on("update", this.handleEditorUpdate.bind(this));
  }
  /**
  ...
  handleEditorUpdate() {
    const r = this.editor.isEditable;
    r !== this.lastEditableState && (this.lastEditableState = r, r ? r && this.handleMap.size === 0 && this.attachHandles() : this.removeHandles());
  }
  /**
  ...
  createContainer() {
    ...
    return r.dataset.resizeContainer = "", r.dataset.node = this.node.type.name, r.style.display = this.node.type.isInline ? "inline-flex" : "flex", this.classNames.container && (r.className = this.classNames.container), r.appendChild(this.wrapper), r;
  }
  /**
...
var ko = class On extends mt {
  ...
  onDragStart(r) {
    var e, t, n, i, s, o, l;
    const { view: a } = this.editor, c = r.target, f = c.nodeType === 3 ? (e = c.parentElement) == null ? void 0 : e.closest("[data-drag-handle]") : c.closest("[data-drag-handle]");
    ...
    let p = null;
    try {
      p = document.createElement("div"), p.style.position = "absolute", p.style.top = "-9999px", p.style.left = "-9999px", p.style.pointerEvents = "none", p.appendChild(h), document.body.appendChild(p), (l = r.dataTransfer) == null || l.setDragImage(h, u, d);
    } finally {
      p && setTimeout(() => {
        try {
          p == null || p.remove();
    ...
    if (typeof m != "number")
      return;
    const g = oe.create(a.state.doc, m), y = a.state.tr.setSelection(g);
    a.dispatch(y);
  }
  stopEvent(r) {
    var e;
    ...
    if (typeof this.options.stopEvent == "function")
      return this.options.stopEvent({ event: r });
    const t = r.target;
    if (!(this.dom.contains(t) && !((e = this.contentDOM) != null && e.contains(t))))
      return !1;
    const i = r.type.startsWith("drag"), s = r.type === "dragover" || r.type === "dragenter", o = r.type === "drop";
    if ((["INPUT", "BUTTON", "SELECT", "TEXTAREA"].includes(t.tagName) || t.isContentEditable) && !o && !i)
      return !0;
    const { isEditable: a } = this.editor, { isDragging: c } = this, f = !!this.node.type.spec.draggable, u = oe.isSelectable(this.node), d = r.type === "copy", h = r.type === "paste", p = r.type === "cut", m = r.type === "mousedown";
    if (!f && u && i && r.target === this.dom && r.preventDefault(), f && i && !c && r.target === this.dom)
      return r.preventDefault(), !1;
    if (f && a && !c && m) {
      const g = t.closest("[data-drag-handle]");
