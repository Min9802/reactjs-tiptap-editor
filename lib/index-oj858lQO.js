...
import { b as a, S as c, y as h, v as n } from "./index-BG0kQamI.js";
const b = "en", D = 20, L = 1e5, w = 16, E = 10, B = 10, N = 2, R = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
...
var k = /* @__PURE__ */ ((t) => (t[t["size-small"] = 200] = "size-small", t[t["size-medium"] = 500] = "size-medium", t["size-large"] = "100%", t))(k || {}), f = /* @__PURE__ */ ((t) => (t[t["size-small"] = 480] = "size-small", t[t["size-medium"] = 640] = "size-medium", t["size-large"] = "100%", t))(f || {});
const P = ["Default", "1.5", "2", "2.5", "3", "3.5", "4"], U = ["Paragraph", 1, 2, 3, 4, 5, 6], y = {
...
function I() {
  const t = a(i).currentLang, o = a(i).message, e = c(i), s = m(
    (l, d) => {
      try {
        let r = (o[t] || {})[l] || l;
        return d && Object.entries(d).forEach(([u, g]) => {
          r = r.replace(new RegExp(`\\{${u}\\}`, "g"), String(g));
        }), r;
      } catch {
        return l;
      }
