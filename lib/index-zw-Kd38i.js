import { M as y, m as d, E as s, g as l } from "./index-BblvcbTH.js";
var p = 20, a = (t, e = 0) => {
  const r = [];
  return !t.children.length || e > p || Array.from(t.children).forEach((n) => {
    n.tagName === "SPAN" ? r.push(n) : n.children.length && r.push(...a(n, e + 1));
  }), r;
}, f = (t) => {
  ...
  e && e.forEach((r) => {
    var n, o;
    const i = r.getAttribute("style"), u = (o = (n = r.parentElement) == null ? void 0 : n.closest("span")) == null ? void 0 : o.getAttribute("style");
    r.setAttribute("style", `${u};${i}`);
  });
}, c = y.create({
  name: "textStyle",
  priority: 101,
  ...
  renderHTML({ HTMLAttributes: t }) {
    return ["span", d(this.options.HTMLAttributes, t), 0];
  },
  addCommands() {
    return {
      ...
      removeEmptyTextStyle: () => ({ tr: t }) => {
        ...
        return t.doc.nodesBetween(e.from, e.to, (r, n) => {
          if (r.isTextblock)
            return !0;
          r.marks.filter((o) => o.type === this.type).some((o) => Object.values(o.attrs).some((i) => !!i)) || t.removeMark(n, n + r.nodeSize, this.type);
        }), !0;
      }
    };
  }
    ...
    return [
      {
        ...
        attributes: {
          backgroundColor: {
            ...
            parseHTML: (t) => {
              var e;
              const r = (e = l(t, "background-color")) != null ? e : t.style.backgroundColor;
              return r == null ? void 0 : r.replace(/['"]+/g, "");
            },
    ...
    return [
      {
        ...
        attributes: {
          color: {
            ...
            parseHTML: (t) => {
              var e;
              const r = (e = l(t, "color")) != null ? e : t.style.color;
              return r == null ? void 0 : r.replace(/['"]+/g, "");
            },
    ...
    return [
      {
        ...
        attributes: {
          fontFamily: {
            ...
            parseHTML: (t) => {
              var e;
              return (e = l(t, "font-family")) != null ? e : t.style.fontFamily;
            },
    ...
    return [
      {
        ...
        attributes: {
          fontSize: {
            ...
            parseHTML: (t) => {
              var e;
              return (e = l(t, "font-size")) != null ? e : t.style.fontSize;
            },
    ...
    return [
      {
        ...
        attributes: {
          lineHeight: {
            ...
            parseHTML: (t) => {
              var e;
              return (e = l(t, "line-height")) != null ? e : t.style.lineHeight;
            },
...
s.create({
  ...
  addExtensions() {
    const t = [];
    return this.options.backgroundColor !== !1 && t.push(h.configure(this.options.backgroundColor)), this.options.color !== !1 && t.push(S.configure(this.options.color)), this.options.fontFamily !== !1 && t.push(g.configure(this.options.fontFamily)), this.options.fontSize !== !1 && t.push(m.configure(this.options.fontSize)), this.options.lineHeight !== !1 && t.push(x.configure(this.options.lineHeight)), this.options.textStyle !== !1 && t.push(c.configure(this.options.textStyle)), t;
  }
});
export {
  S as C,
