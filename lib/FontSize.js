...
function $() {
  ...
  return n ? /* @__PURE__ */ d(F, { children: [
    /* @__PURE__ */ r(M, { asChild: !0, disabled: l, children: /* @__PURE__ */ r(
      y,
      {
        disabled: l,
        icon: f,
    ...
    /* @__PURE__ */ r(g, { className: "richtext-max-h-96 richtext-w-32 richtext-overflow-y-auto", children: a == null ? void 0 : a.map((o, c) => /* @__PURE__ */ d(D, { children: [
      /* @__PURE__ */ r(w, { checked: i === o.title, onClick: o.action, children: /* @__PURE__ */ r("div", { className: "richtext-ml-1 richtext-h-full", children: o.title }) }),
