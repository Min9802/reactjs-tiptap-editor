import { N as j, m as P } from "./index-BblvcbTH.js";
import { N as x, c as y, a as D } from "./clsx-0OU6n9va.js";
import { P as R, Q as $, U as I, F as O, V as W, W as Z, X as N, A as T, u as K, d as Q } from "./index-BrsJsbds.js";
...
import { u as ie } from "./index-oj858lQO.js";
...
function ne(t) {
  const o = oe[t], s = new DOMParser().parseFromString(o, "image/svg+xml").documentElement, n = [
    "svg",
    {
      ...Array.from(s.attributes).reduce((i, a) => (i[a.name] = a.value, i), {})
    }
  ];
  return Array.from(s.childNodes).forEach((i) => {
    if (i.nodeType === 1) {
      const a = [
        ...
        Array.from(i.attributes).reduce((d, h) => (d[h.name] = h.value, d), {})
      ];
      i.textContent && a.push(i.textContent), n.push(a);
    }
  }), n;
}
const ae = {
